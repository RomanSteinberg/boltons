...
from typing import Any, Iterable, Protocol, TypeVar, AbstractSet
...
class SupportsKeysAndItems(Protocol[_KT, _VT_co]):
...
class OrderedMultiDict(dict):
    ...
    def add(self, k: str, v: Incomplete) -> None: ...
    def addlist(self, k: str, v: Iterable) -> None: ...
    def get(self, k: str, default: Incomplete | None = ...): ...
    def getlist(self, k: str, default: Incomplete =...): ...
    def clear(self) -> None: ...
    def setdefault(self, k: str, default=...) -> Iterable | None: ...
    def copy(self): ...
    @classmethod
    ...
    def __setitem__(self, k: str, v: Incomplete) -> None: ...
    def __getitem__(self, k: str) -> Iterable: ...
    def __delitem__(self, k: str) -> None: ...
    def __eq__(self, other: OrderedMultiDict) -> bool: ...
    def __ne__(self, other: OrderedMultiDict) -> bool: ...
    def pop(self, k: str, default: Incomplete = ...) -> Incomplete: ...
    def popall(self, k: str, default: Incomplete = ...) -> Iterable: ...
